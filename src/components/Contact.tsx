            ...
            <div className={`${themeClasses.cardBg} ${themeClasses.cardBorder} border backdrop-blur-sm rounded-2xl sm:rounded-3xl p-5 sm:p-8`}>
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className={`${themeClasses.textSecondary} text-sm sm:text-base break-all`}>thearvedit@gmail.com</p>
                </div>
              </div>
            </div>
              ...
              <div className="relative">
                <div className="relative">
                  ...
                  <div className="flex flex-wrap gap-3 sm:gap-4">
                    <a href="https://www.instagram.com/thearvedit" target="_blank" rel="noopener noreferrer" className={`w-11 h-11 sm:w-12 sm:h-12 min-w-[44px] min-h-[44px] ${themeClasses.gradient} rounded-lg flex items-center justify-center transition-all active:scale-95 sm:hover:scale-110`}>
                    ...
                    <a href="https://www.youtube.com/@thearvedit" target="_blank" rel="noopener noreferrer" className={`w-11 h-11 sm:w-12 sm:h-12 min-w-[44px] min-h-[44px] ${themeClasses.gradient} rounded-lg flex items-center justify-center transition-all active:scale-95 sm:hover:scale-110`}>
                      <svg className={`w-5 h-5 sm:w-6 sm:h-6 ${themeClasses.textWhite}`} fill="currentColor" viewBox="0 0 24 24">
