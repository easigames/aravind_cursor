              ...
              <div className="relative">
                <div className="relative">
                  ...
                  <div className="flex flex-wrap gap-3 sm:gap-4">
                    <a href="https://www.instagram.com/arvedit" target="_blank" rel="noopener noreferrer" className={`w-11 h-11 sm:w-12 sm:h-12 min-w-[44px] min-h-[44px] ${themeClasses.gradient} rounded-lg flex items-center justify-center transition-all active:scale-95 sm:hover:scale-110`}>
                    ...
                    <a href="https://www.youtube.com/@arvedit" target="_blank" rel="noopener noreferrer" className={`w-11 h-11 sm:w-12 sm:h-12 min-w-[44px] min-h-[44px] ${themeClasses.gradient} rounded-lg flex items-center justify-center transition-all active:scale-95 sm:hover:scale-110`}>
                      <svg className={`w-5 h-5 sm:w-6 sm:h-6 ${themeClasses.textWhite}`} fill="currentColor" viewBox="0 0 24 24">
