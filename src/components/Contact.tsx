...
export default function Contact() {
  ...
  return (
    <section id="contact" className={`py-20 relative overflow-hidden ${themeClasses.bgPrimary}`}>
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          {/* Contact Form */}
          <div className={`${themeClasses.cardBg} ${themeClasses.cardBorder} border backdrop-blur-sm rounded-3xl p-8 md:p-10`}>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="service" className={`block ${themeClasses.textPrimary} font-semibold mb-2`}>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 rounded-lg ${themeClasses.inputBg} ${themeClasses.inputBorder} border ${themeClasses.inputText} ${themeClasses.inputPlaceholder} focus:border-purple-600 focus:ring-2 focus:ring-purple-600/20 outline-none transition-all appearance-none cursor-pointer`}
          ...
          <div className="space-y-8">
            {/* Contact Cards */}
            <div className={`${themeClasses.cardBg} ${themeClasses.cardBorder} border backdrop-blur-sm rounded-3xl p-8`}>
              <div className="flex items-start space-x-4">
                <div className={`flex-shrink-0 w-12 h-12 ${themeClasses.gradient} rounded-lg flex items-center justify-center`}>
                ...
                <div>
                  <h3 className={`text-lg font-bold ${themeClasses.textPrimary} mb-1`}>Email Us</h3>
                  <p className={themeClasses.textSecondary}>hello@videoedit.com</p>
                  <p className={themeClasses.textSecondary}>support@videoedit.com</p>
                </div>
              </div>
            </div>
            ...
            <div className={`${themeClasses.cardBg} ${themeClasses.cardBorder} border backdrop-blur-sm rounded-3xl p-8`}>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className={`text-lg font-bold ${themeClasses.textPrimary} mb-1`}>Call Us</h3>
                  <p className={themeClasses.textSecondary}>+1 (555) 123-4567</p>
                  <p className={themeClasses.textSecondary}>Mon-Fri 9am-6pm EST</p>
                </div>
              </div>
            </div>
            ...
            <div className={`${themeClasses.cardBg} ${themeClasses.cardBorder} border backdrop-blur-sm rounded-3xl p-8`}>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className={`text-lg font-bold ${themeClasses.textPrimary} mb-1`}>Visit Us</h3>
                  <p className={themeClasses.textSecondary}>123 Creative Street</p>
                  <p className={themeClasses.textSecondary}>New York, NY 10001</p>
                </div>
              </div>
            </div>
            ...
            <div className={`${themeClasses.cardBg} ${themeClasses.cardBorder} border backdrop-blur-sm rounded-3xl p-8`}>
              <div className="relative">
                <div className="relative">
                  <h3 className={`text-2xl font-bold ${themeClasses.textPrimary} mb-4`}>Follow Us</h3>
                  <p className={`mb-6 ${themeClasses.textSecondary}`}>Stay connected on social media</p>
                  <div className="flex space-x-4">
                    <a href="#" className={`w-12 h-12 ${themeClasses.gradient} rounded-lg flex items-center justify-center transition-all hover:scale-110`}>
                      <svg className={`w-6 h-6 ${themeClasses.textWhite}`} fill="currentColor" viewBox="0 0 24 24">
