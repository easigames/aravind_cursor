      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="mb-6 sm:mb-8 lg:hidden">
          ...
          <div className="flex gap-2.5">
            <a href="#" className={`w-9 h-9 min-w-[36px] min-h-[36px] ${themeClasses.gradient} rounded-lg flex items-center justify-center transition-all active:scale-95`}>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-12 mb-6 sm:mb-8">
          ...
          <div className="hidden lg:block">
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#" className={`w-11 h-11 min-w-[44px] min-h-[44px] ${themeClasses.gradient} rounded-lg flex items-center justify-center transition-all active:scale-95 sm:hover:scale-110`}>
