...
export default function Footer() {
  ...
  return (
    <footer className={`${themeClasses.footerBg} ${themeClasses.footerText} py-16 relative`}>
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className={`w-10 h-10 ${themeClasses.gradient} rounded-lg flex items-center justify-center transition-all hover:scale-110`}>
          ...
          {/* Quick Links */}
          <div>
            <h3 className={`text-lg font-bold mb-4 ${themeClasses.footerHeading}`}>Quick Links</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/services" className={`${themeClasses.footerLink} transition-colors`}>
                  Services
                </Link>
              </li>
              <li>
                <Link href="/portfolio" className={`${themeClasses.footerLink} transition-colors`}>
                  Portfolio
                </Link>
              </li>
              <li>
                <Link href="/pricing" className={`${themeClasses.footerLink} transition-colors`}>
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="/about" className={`${themeClasses.footerLink} transition-colors`}>
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/faq" className={`${themeClasses.footerLink} transition-colors`}>
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/contact" className={`${themeClasses.footerLink} transition-colors`}>
                  Contact
                </Link>
              </li>
            </ul>
          ...
          {/* Services */}
          <div>
            <h3 className={`text-lg font-bold mb-4 ${themeClasses.footerHeading}`}>Services</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/services" className={`${themeClasses.footerLink} transition-colors`}>
        ...
        {/* Bottom Bar */}
        <div className={`border-t ${themeClasses.footerBorder} pt-8`}>
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className={`${themeClasses.textSecondary} text-sm mb-4 md:mb-0`}>
              © 2025 ArvEdit. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <Link href="#" className={`${themeClasses.footerLink} text-sm transition-colors`}>
                Privacy Policy
              </Link>
              <Link href="#" className={`${themeClasses.footerLink} text-sm transition-colors`}>
                Terms of Service
